...
const contract_abi = require("./abis/usdc_ftm_abi");
const usdc_abi = require("./abis/erc20_abi");
const ftm_abi = require("./abis/erc20_abi");
...
async function spookySwap_ftm_usdc_collector() {
  try {
    ...
    const ftmContract = new web3.eth.Contract(ftm_abi, usdcAddress);
    const usdcContract = new web3.eth.Contract(usdc_abi, ftmAddress);
    const priceFtmContract = new web3.usdc.Contract(
      priceFtm_abi,
      priceFeedFtmAddress
    );
    ...
    console.log(booPerSecond.toString());
