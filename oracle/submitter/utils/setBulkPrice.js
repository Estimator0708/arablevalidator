...
exports.setBulkPrice = async function(tokenArray, priceArray) {
    ...
    priceArray = priceArray.map(price => web3.utils.toHex(web3.utils.toWei(`${price}`, 'ether')))
    const setBulkPrice = priceContract.methods.bulkPriceSet(tokenArray, priceArray)
